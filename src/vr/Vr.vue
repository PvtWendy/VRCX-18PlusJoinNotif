...
<script setup>
    ...
    function playNoty(json) {
        ...
        console.error('playNoty received:', { noty, message, image });
        ...
        let text = '';
        let img = '';
        // Show SVG icon if user has 18+ age verification
        let showSvgIcon = noty.ageVerified === '18+';
        if (image) {
            ...
            new Noty({
                ...
                text: `
                        <div style="display: flex; align-items: center; flex-direction: row;">
                            ${showSvgIcon ? `<svg fill="#44ff44" style="flex-shrink: 0; width: 32px; height: 32px; margin-right: 8px;">
                                <path d="M 55.49 10.87 c -10 -0.3 -18.54 -4.45 -22.5 -10.34 c -0.24 -0.36 -0.62 -0.53 -0.99 -0.53 s -0.75 0.18 -0.99 0.53 c -3.96 5.89 -12.5 10.04 -22.5 10.34 c -0.64 0.02 -1.15 0.54 -1.15 1.18 v 22.78 c 0 7.42 3.52 14.4 9.49 18.82 l 13.08 9.67 c 0.62 0.46 1.34 0.68 2.07 0.68 s 1.46 -0.23 2.07 -0.68 l 1.86 -1.38 c -0.85 -0.7 -1.64 -1.48 -2.34 -2.33 l -1.46 1.08 s -0.08 0.04 -0.13 0.04 s -0.09 -0.01 -0.13 -0.04 l -13.08 -9.67 c -5.11 -3.78 -8.16 -9.83 -8.16 -16.19 V 14.03 c 8.81 -0.7 16.65 -4.18 21.38 -9.46 c 4.73 5.28 12.56 8.77 21.38 9.46 v 17.52 c 1.15 0.42 2.23 0.96 3.25 1.61 V 12.05 c 0 -0.64 -0.51 -1.16 -1.15 -1.18 Z M 48.72 18.46 v 12.05 c -0.49 -0.05 -0.99 -0.07 -1.5 -0.07 c -9.8 0 -17.78 7.98 -17.78 17.78 c 0 1.61 0.22 3.17 0.62 4.65 l -8.35 -6.18 c -4.05 -2.99 -6.44 -7.73 -6.44 -12.77 v -15.46 c 0 -0.43 0.34 -0.79 0.78 -0.8 c 6.79 -0.2 12.59 -3.02 15.28 -7.02 h -0.02 c 0.33 -0.48 1.03 -0.48 1.35 0 c 2.69 4 8.49 6.82 15.28 7.02 c 0.43 0.01 0.78 0.36 0.78 0.8 Z M 47.22 33.44 c -8.16 0 -14.78 6.62 -14.78 14.78 s 6.62 14.78 14.78 14.78 s 14.78 -6.62 14.78 -14.78 s -6.62 -14.78 -14.78 -14.78 Z M 57.53 43.56 l -12.7 12.63 c -0.21 0.21 -0.55 0.21 -0.76 0 l -7.16 -7.14 c -0.28 -0.28 -0.28 -0.73 0 -1.01 l 2.26 -2.26 c 0.29 -0.28 0.74 -0.28 1.03 0 l 4.26 4.24 l 9.78 -9.72 c 0.29 -0.28 0.75 -0.28 1.03 0 l 2.26 2.25 c 0.29 0.28 0.29 0.73 0 1.01 Z" />
                            </svg>` : ''}
                            ${img}
                            <div class="noty-text">${text}</div>
                        </div>`
            }).show();
        }
    }
